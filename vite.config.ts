...
export default defineConfig({
  base: "/Cr2026/", // OBRIGATÓRIO: Nome exato do seu repositório
  plugins,
  resolve: {
    alias: {
  ...
  envDir: PROJECT_ROOT,
  root: path.resolve(PROJECT_ROOT, "client"), // Define a pasta client como a origem
  build: {
    outDir: path.resolve(PROJECT_ROOT, "dist"), // Joga o site pronto na pasta dist na RAIZ
    emptyOutDir: true,
  },
  server: {
    port: 3000,
